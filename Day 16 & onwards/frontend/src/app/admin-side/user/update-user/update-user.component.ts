...
export class UpdateUserComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.updateForm = this.fb.group({
      ...
      emailAddress: ['', [Validators.required, this.customEmailValidator]], // Apply custom email validator
      password: ['', [Validators.required, Validators.minLength(5), Validators.maxLength(10)]],
      confirmPassword: ['', [Validators.required, this.passwordCompareValidator]]
    }, {
  ...
  FetchDetail(id: any) {
    this.service.GetUserById(id).subscribe((data: any) => {
      ...
      this.updateForm = this.fb.group({
        ...
        emailAddress: [this.updateData.emailAddress, Validators.compose([Validators.required, this.customEmailValidator])],
